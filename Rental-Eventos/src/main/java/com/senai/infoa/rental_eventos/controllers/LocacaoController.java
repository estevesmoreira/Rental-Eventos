...
import com.senai.infoa.rental_eventos.models.LocacaoService;
...
public class LocacaoController {
    ...
    public long contarLocacoes() {
        return locacaoService.contarLocacoes();
    }

    @GetMapping("/buscar-locacao/{id}")
    public Locacao buscarLocacao(@PathVariable Integer id) {
    ...
    public String deletarLocacao(@PathVariable Integer id) {
